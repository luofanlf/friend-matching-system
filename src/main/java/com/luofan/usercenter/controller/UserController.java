package com.luofan.usercenter.controller;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.luofan.usercenter.common.ErrorCode;
import com.luofan.usercenter.model.domain.User;
import com.luofan.usercenter.model.request.UserLoginRequest;
import com.luofan.usercenter.model.request.UserRegisterRequest;
...
public class UserController {
    ...
    public BaseResponse<Page<User>> recommendUsers(long pageSize,long pageNum,HttpServletRequest request) {
        ...
        String redisKey = String.format("luofan:user:recommend:%s", loginUser.getId());
